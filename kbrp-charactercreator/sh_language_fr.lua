DarkRP.RegisterSentences("kbrp_charactercreator", "fr", {
	...
	["enterYourName"] = "Veuillez indiquer votre prénom et votre nom",
	["chooseYourAppearance"] = "Veuillez choisir votre apparence",
	["enterYourNamePlaceholder"] = "Exemple : Fabrice Lamare",
	["cantAffordModification"] = "Vous n'avez pas suffisamment d'argent pour payer la modification !",
	...
	["cantAfford"] = "Vous n'avez pas suffisamment d'argent !",
