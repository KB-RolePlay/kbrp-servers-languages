DarkRP.RegisterSentences("kbrp_firefighter", "fr", {
	...
	["playerNotHaveEnoughtMoneyToBeCare"] = "La personne n'a pas assez d'argent pour être soignée",
	["playerInActionCanBeCared"] = "La personne pourras être soignée dans %ss car elle est en action",
	["carePlayerReward"] = "En soignant %s vous venez de recevoir %s€",
	["caredByPlayer"] = "Vous avez été facturé de %s€ pour le soin de %s"
})